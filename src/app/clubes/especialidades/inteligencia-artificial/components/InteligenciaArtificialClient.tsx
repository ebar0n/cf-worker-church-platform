...
export default function InteligenciaArtificialClient() {
  const [answers, setAnswers] = useState<Record<number, string>>({});
  const [presentationDates, setPresentationDates] = useState<Record<number, string>>({});
  const [visitInfo, setVisitInfo] = useState<{ place: string; date: string }>({
    place: '',
    date: '',
  });
...
• Traductores automáticos como Google Translate`,
    ...
    },
    {
      id: 2,
      question:
        'Individualmente o en un grupo, desarrollar un diagrama que muestra en forma breve la historia de la inteligencia artificial. Preparar y dar una presentación oral.',
...
• Desafío: hacer androides que no sean "espeluznantes"`,
    ...
    },
    {
      id: 5,
      question:
        'Respecto al campo de la inteligencia artificial, definir los siguientes términos: Inteligencia general, Inteligencia social, Creatividad, Aprendizaje, Moción, Planificación, Percepción, Heurística, Reconocimiento de patrones, Red neuronal, Procesamiento de lenguaje natural, Ingeniería de inteligencia',
...
• Optimización para hardware específico (CPUs, GPUs, TPUs)`,
    ...
    },
    {
      id: 6,
      question:
        'Dar 3 ejemplos reales de cómo se usa la inteligencia artificial para ayudar a la sociedad.',
...
• **Chile**: IA predice actividad sísmica en la cordillera de Los Andes`,
    ...
    },
    {
      id: 7,
      question:
        '¿Cuáles son algunas de las limitaciones de la inteligencia artificial? Explicar por lo menos 3 de ellas.',
...
• Decisiones puramente lógicas pueden ser éticamente problemáticas`,
    ...
    },
    {
      id: 8,
      question:
        '¿Cuáles son algunas habilidades básicas humanas que la inteligencia artificial no puede exhibir?',
      answer: `**Respuesta básica:**
...
• Robótica usa sistemas expertos para toma de decisiones en tiempo real`,
    ...
    },
    {
      id: 12,
      question:
        'Individualmente o en un grupo, discutir la importancia de la inteligencia artificial y su papel en la sociedad. Preparar y dar una presentación oral.',
...
• Votar por propuestas más viables/éticas`,
    ...
    },
    {
      id: 13,
      question:
        'Basado en sus observaciones de la pregunta anterior, visitar un lugar que ha utilizado el uso de la inteligencia artificial. Preparar y dar una presentación oral.',
      answer: `**Guía básica:**
...
• Props/objetos físicos relacionados con la visita`,
    ...
    },
    {
      id: 14,
      question:
        'Discutir con un grupo varios pasajes bíblicos que hablan de la inteligencia humana. Comparar y contrastar inteligencia artificial moderna con la inteligencia que Dios dio a Sus criaturas. Algunos textos incluyen: Génesis 1:26 y 27; Salmo 139; y Salmo 8:3-6.',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="print-only mb-6 text-center">
          <div className="mb-4 flex items-center justify-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm">
                Nivel de destreza 2 • Actividades vocacionales • División Norteamericana
              </p>
            </div>
          </div>
        ...
        <div className="no-print mb-12 text-center">
          <div className="mb-6 flex flex-col items-center justify-center gap-6 sm:flex-row">
            <div className="relative">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#4b207f] to-[#6b46c1] p-1 shadow-xl">
              ...
              <div className="h-[132px] w-[132px]"></div> {/* Spacer for absolute positioning */}
            </div>
            <div className="text-center sm:text-left">
              <h1 className="mb-3 text-4xl font-bold text-[#4b207f]">
          ...
          <div className="mb-6">
            <div className="inline-block rounded-2xl bg-gradient-to-r from-red-500 to-red-600 p-1 shadow-lg">
              <a
                href="/departments/clubes/especialidades/inteligencia_artificial.pdf"
                download
                className="flex items-center gap-3 rounded-xl bg-white px-8 py-4 font-semibold text-red-600 transition-all hover:bg-red-50"
              >
                <svg
                ...
                >
                  <path
                    ...
                    d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-6a3.375 3.375 0 00-3.375 3.375v2.625M12 6v6m0 0l3-3m-3 3l-3-3"
                  />
                </svg>
                <span>Descargar documento PDF oficial</span>
                <span className="rounded-full bg-red-100 px-2 py-1 text-sm">PDF</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="no-print mb-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
          {/* Información general */}
          <div className="rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-8">
            ...
            <div className="space-y-4 text-gray-700">
              <p className="leading-relaxed">
                La especialidad de <strong>Inteligencia Artificial</strong> te introduce al
                fascinante mundo de la IA, desde sus fundamentos históricos hasta sus aplicaciones
                modernas en la sociedad.
              </p>
              <div className="rounded-lg border-l-4 border-blue-500 bg-white p-4">
                <h3 className="mb-2 font-semibold text-blue-900">¿Qué aprenderás?</h3>
          ...
          <div className="rounded-xl border border-green-100 bg-gradient-to-br from-green-50 to-emerald-50 p-8">
            <div className="mb-6 flex items-center gap-3">
            ...
            <div className="space-y-6">
              <div className="rounded-lg border-l-4 border-green-500 bg-white p-4">
                <h3 className="mb-3 font-semibold text-green-900">Objetivos de aprendizaje:</h3>
                <ul className="space-y-1 text-sm text-gray-700">
                  ...
                  <li>
                    • Reflexionar sobre la inteligencia humana desde una perspectiva cristiana
                  </li>
                </ul>
              </div>
              <div className="rounded-lg border-l-4 border-emerald-500 bg-white p-4">
                <h3 className="mb-3 font-semibold text-emerald-900">Recursos recomendados:</h3>
                <ul className="space-y-1 text-sm text-gray-700">
        ...
        <div className="mx-auto max-w-4xl">
          <form className="space-y-8">
            ...
            <div className="no-print rounded-lg border border-gray-200 p-4">
              ...
              <div key={q.id} className="question-block rounded-lg border border-gray-200 p-4">
                ...
                <div className="no-print mb-3">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-lg bg-blue-100 px-3 py-1 text-sm text-blue-700 transition-colors hover:bg-blue-200"
                  >
                ...
                {showHelp[q.id] && (
                  <div className="no-print mb-4 rounded-lg bg-blue-50 p-4">
                    <h4 className="mb-2 font-medium text-blue-800">Respuesta de referencia:</h4>
                    <div className="whitespace-pre-line text-sm text-blue-700">{q.answer}</div>
                  </div>
                )}
                  ...
                  <div className="mt-3 space-y-3">
                    <div className="form-field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setVisitInfo((prev) => ({ ...prev, place: e.target.value }))
                        }
                      />
                    </div>
                    <div className="form-field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setVisitInfo((prev) => ({ ...prev, date: e.target.value }))
                        }
                      />
                    </div>
                  </div>
            ...
            <div className="no-print flex justify-center">
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-green-600 px-8 py-3 font-semibold text-white transition-colors hover:bg-green-700"
              >
